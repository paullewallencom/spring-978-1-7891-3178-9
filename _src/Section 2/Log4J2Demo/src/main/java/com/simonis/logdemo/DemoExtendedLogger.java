 ...
 * the DIAG, VERBOSE and NOTICE custom log levels.
 * <p>Compatible with Log4j 2.6 or higher.</p>
 */
public final class DemoExtendedLogger extends ExtendedLoggerWrapper {
    private static final long serialVersionUID = 1035732076013424L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = DemoExtendedLogger.class.getName();
    private static final Level DIAG = Level.forName("DIAG", 350);
    private static final Level VERBOSE = Level.forName("VERBOSE", 450);
    private static final Level NOTICE = Level.forName("NOTICE", 550);

    private DemoExtendedLogger(final Logger logger) {
     ...
     */
    public static DemoExtendedLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new DemoExtendedLogger(wrapped);
    }
     ...
     */
    public static DemoExtendedLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static DemoExtendedLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static DemoExtendedLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static DemoExtendedLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static DemoExtendedLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static DemoExtendedLogger create(final String name, final MessageFactory messageFactory) {
