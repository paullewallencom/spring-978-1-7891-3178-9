 ...
 */
public final class DemoCustomLogger implements Serializable {
    private static final long serialVersionUID = 1035911784539012L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = DemoCustomLogger.class.getName();
    ...
    private DemoCustomLogger(final Logger logger) {
     ...
     */
    public static DemoCustomLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new DemoCustomLogger(wrapped);
    }
     ...
     */
    public static DemoCustomLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static DemoCustomLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static DemoCustomLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static DemoCustomLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static DemoCustomLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static DemoCustomLogger create(final String name, final MessageFactory messageFactory) {
